...
import com.rjcovid19project.Models.Test_Labs;
import com.rjcovid19project.Models.Toll_Numbers;
...
public class TollNumbersAdapter extends RecyclerView.Adapter<TollNumbersAdapter.ImageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ImageViewHolder holder, final int position) {
        ...
        holder.Phone_number.setText(test_labs.getName()+", "+test_labs.getDest());
        holder.Phone_number.setText("Mobile Number : "+test_labs.getMobile_number());
        holder.Phone_number.setText("LandLine Number : "+test_labs.getLand_line_number());
